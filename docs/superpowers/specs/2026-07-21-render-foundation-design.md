...
**Golden images (WARP, deterministic):**
- Raised, inset, and flat at several sizes and radii.
- Both light and dark bases.
- 100%, 150%, 200% DPI scales.
- Comparison is **exact**, since WARP is bit-reproducible. Any tolerance would defeat the point.
- Goldens are regenerated by an explicit flag, never silently on mismatch.
